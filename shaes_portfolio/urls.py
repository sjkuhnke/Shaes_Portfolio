...
urlpatterns = [
    ...
    path('xhenos/natures/<str:nature_name>/', views.nature_lookup, name='nature_lookup'),
    path('xhenos/abilities/<str:ability_name>/', views.ability_lookup, name='ability_lookup'),
